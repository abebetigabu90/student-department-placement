///run Other Social Placement 
import React, { useState } from 'react';
import axios from 'axios';

const OtherSocialPlacement = () => {
  ...
  const runPlacement = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/api/admin/placement/runOtherSocialPlacement');
    ...
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="text-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">
          Other Social Students Placement
        </h1>
        <p className="text-gray-600">
          Run automated placement process for Other Social Second Semister students
        </p>
      </div>
...
export default OtherSocialPlacement;