//runPreEngineeringPlacement
import React, { useState } from 'react';
import axios from 'axios';

const PreEngineeringPlacement = () => {
  ...
  const runPlacement = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/api/admin/placement/runPreEngineeringPlacement');
    ...
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="text-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">
          PreEngineering Students Placement
        </h1>
        <p className="text-gray-600">
          Run automated placement process for PreEngineering Second Semister students
        </p>
      </div>
...
export default PreEngineeringPlacement;