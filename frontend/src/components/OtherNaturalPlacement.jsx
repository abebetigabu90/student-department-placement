//runOtherNaturalPlacementPlacement
import React, { useState } from 'react';
import axios from 'axios';

const OtherNaturalPlacement = () => {
  ...
  const runPlacement = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/api/admin/placement/runOtherNaturalPlacement');
    ...
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="text-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">
          Other Natural Students Placement
        </h1>
        <p className="text-gray-600">
          Run automated placement process for Other Natural Second Semister students
        </p>
      </div>
...
export default OtherNaturalPlacement;